...
mixin _$MediaDetail {
 ...
 String get id; String get serverId; String get title; String get overview; int get runtimeSeconds; int get resumePositionSeconds; int? get year; List<String> get genres; String get mediaType; String get streamUrl; String? get mediaSourceId; String? get playSessionId;
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,id,serverId,title,overview,runtimeSeconds,resumePositionSeconds,year,const DeepCollectionEquality().hash(genres),mediaType,streamUrl,mediaSourceId,playSessionId);

@override
String toString() {
  return 'MediaDetail(id: $id, serverId: $serverId, title: $title, overview: $overview, runtimeSeconds: $runtimeSeconds, resumePositionSeconds: $resumePositionSeconds, year: $year, genres: $genres, mediaType: $mediaType, streamUrl: $streamUrl, mediaSourceId: $mediaSourceId, playSessionId: $playSessionId)';
}
...
@useResult
$Res call({
 String id, String serverId, String title, String overview, int runtimeSeconds, int resumePositionSeconds, int? year, List<String> genres, String mediaType, String streamUrl, String? mediaSourceId, String? playSessionId
});
...
/// Create a copy of MediaDetail
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? id = null,Object? serverId = null,Object? title = null,Object? overview = null,Object? runtimeSeconds = null,Object? resumePositionSeconds = null,Object? year = freezed,Object? genres = null,Object? mediaType = null,Object? streamUrl = null,Object? mediaSourceId = freezed,Object? playSessionId = freezed,}) {
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String id,  String serverId,  String title,  String overview,  int runtimeSeconds,  int resumePositionSeconds,  int? year,  List<String> genres,  String mediaType,  String streamUrl,  String? mediaSourceId,  String? playSessionId)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _MediaDetail() when $default != null:
return $default(_that.id,_that.serverId,_that.title,_that.overview,_that.runtimeSeconds,_that.resumePositionSeconds,_that.year,_that.genres,_that.mediaType,_that.streamUrl,_that.mediaSourceId,_that.playSessionId);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String id,  String serverId,  String title,  String overview,  int runtimeSeconds,  int resumePositionSeconds,  int? year,  List<String> genres,  String mediaType,  String streamUrl,  String? mediaSourceId,  String? playSessionId)  $default,) {final _that = this;
switch (_that) {
case _MediaDetail():
return $default(_that.id,_that.serverId,_that.title,_that.overview,_that.runtimeSeconds,_that.resumePositionSeconds,_that.year,_that.genres,_that.mediaType,_that.streamUrl,_that.mediaSourceId,_that.playSessionId);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String id,  String serverId,  String title,  String overview,  int runtimeSeconds,  int resumePositionSeconds,  int? year,  List<String> genres,  String mediaType,  String streamUrl,  String? mediaSourceId,  String? playSessionId)?  $default,) {final _that = this;
switch (_that) {
case _MediaDetail() when $default != null:
return $default(_that.id,_that.serverId,_that.title,_that.overview,_that.runtimeSeconds,_that.resumePositionSeconds,_that.year,_that.genres,_that.mediaType,_that.streamUrl,_that.mediaSourceId,_that.playSessionId);case _:
  return null;
...
class _MediaDetail implements MediaDetail {
  const _MediaDetail({required this.id, required this.serverId, required this.title, required this.overview, this.runtimeSeconds = 0, this.resumePositionSeconds = 0, this.year, final  List<String> genres = const <String>[], required this.mediaType, required this.streamUrl, this.mediaSourceId, this.playSessionId}): _genres = genres;
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,id,serverId,title,overview,runtimeSeconds,resumePositionSeconds,year,const DeepCollectionEquality().hash(_genres),mediaType,streamUrl,mediaSourceId,playSessionId);
...
/// Create a copy of MediaDetail
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? id = null,Object? serverId = null,Object? title = null,Object? overview = null,Object? runtimeSeconds = null,Object? resumePositionSeconds = null,Object? year = freezed,Object? genres = null,Object? mediaType = null,Object? streamUrl = null,Object? mediaSourceId = freezed,Object? playSessionId = freezed,}) {
